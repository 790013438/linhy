...
<html lang="zh">
	<head>
		<%@include file="../student/commonHead.jsp"%>
	</head>

	<body>
	<%@include file="../student/commonLeft.jsp"%>
	...
	<div class="main-content">
		...
		<!-- basic scripts -->
		<%@include file="../student/commonFoot.jsp"%>
	<script src="${resource}/resource/js/moment.js"></script>
	<script src="${resource}/resource/js/student_showInfo.js"></script>
</body>
</html>
